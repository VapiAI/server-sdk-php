...
class OpenRouterModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
