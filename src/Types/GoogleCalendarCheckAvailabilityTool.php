 ...
 */
class GoogleCalendarCheckAvailabilityTool extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<GoogleCalendarCheckAvailabilityToolMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
