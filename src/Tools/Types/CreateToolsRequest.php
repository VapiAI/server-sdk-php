...
class CreateToolsRequest extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): CreateToolsRequest
    {
     ...
     * @return CreateToolsRequest
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return CreateToolsRequest
     */
    public static function endCall(CreateEndCallToolDto $endCall): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return CreateToolsRequest
     */
    public static function function(CreateFunctionToolDto $function): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'function',
            'value' => $function,
     ...
     * @return CreateToolsRequest
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return CreateToolsRequest
     */
    public static function handoff(CreateHandoffToolDto $handoff): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return CreateToolsRequest
     */
    public static function bash(CreateBashToolDto $bash): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return CreateToolsRequest
     */
    public static function computer(CreateComputerToolDto $computer): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return CreateToolsRequest
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return CreateToolsRequest
     */
    public static function query(CreateQueryToolDto $query): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'query',
            'value' => $query,
     ...
     * @return CreateToolsRequest
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function sms(CreateSmsToolDto $sms): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return CreateToolsRequest
     */
    public static function mcp(CreateMcpToolDto $mcp): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return CreateToolsRequest
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): CreateToolsRequest
    {
        return new CreateToolsRequest([
     ...
     * @return CreateToolsRequest
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return CreateToolsRequest
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): CreateToolsRequest
    {
        return new CreateToolsRequest([
            'type' => 'voicemail',
            'value' => $voicemail,
