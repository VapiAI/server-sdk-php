 ...
 */
class UpdateAssistantDraftDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function anthropic(AnthropicModel $anthropic): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
        ]);
    }
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function anthropicBedrock(AnthropicBedrockModel $anthropicBedrock): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function anyscale(AnyscaleModel $anyscale): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function cerebras(CerebrasModel $cerebras): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function customLlm(CustomLlmModel $customLlm): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function deepinfra(DeepInfraModel $deepinfra): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function deepSeek(DeepSeekModel $deepSeek): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function google(GoogleModel $google): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function groq(GroqModel $groq): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function inflectionAi(InflectionAiModel $inflectionAi): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function openai(OpenAiModel $openai): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function openrouter(OpenRouterModel $openrouter): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function togetherAi(TogetherAiModel $togetherAi): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function xai(XaiModel $xai): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return UpdateAssistantDraftDtoModel
     */
    public static function vapi(VapiModel $vapi): UpdateAssistantDraftDtoModel
    {
        return new UpdateAssistantDraftDtoModel([
            'provider' => 'vapi',
            'value' => $vapi,
