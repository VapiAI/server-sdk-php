...
class InsightControllerRemoveResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'bar'
     ...
     */
    public static function bar(BarInsight $bar): InsightControllerRemoveResponse
    {
        return new InsightControllerRemoveResponse([
            'type' => 'bar',
            'value' => $bar,
        ]);
    }
     ...
     * @return InsightControllerRemoveResponse
     */
    public static function pie(PieInsight $pie): InsightControllerRemoveResponse
    {
        return new InsightControllerRemoveResponse([
            'type' => 'pie',
            'value' => $pie,
     ...
     * @return InsightControllerRemoveResponse
     */
    public static function line(LineInsight $line): InsightControllerRemoveResponse
    {
        return new InsightControllerRemoveResponse([
            'type' => 'line',
            'value' => $line,
     ...
     * @return InsightControllerRemoveResponse
     */
    public static function text(TextInsight $text): InsightControllerRemoveResponse
    {
        return new InsightControllerRemoveResponse([
            'type' => 'text',
            'value' => $text,
