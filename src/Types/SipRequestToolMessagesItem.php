...
class SipRequestToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return SipRequestToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): SipRequestToolMessagesItem
    {
        return new SipRequestToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return SipRequestToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): SipRequestToolMessagesItem
    {
        return new SipRequestToolMessagesItem([
     ...
     * @return SipRequestToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): SipRequestToolMessagesItem
    {
        return new SipRequestToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return SipRequestToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): SipRequestToolMessagesItem
    {
        return new SipRequestToolMessagesItem([
