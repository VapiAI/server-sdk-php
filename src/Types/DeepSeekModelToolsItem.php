...
class DeepSeekModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
