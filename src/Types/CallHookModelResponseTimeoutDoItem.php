...
class CallHookModelResponseTimeoutDoItem extends JsonSerializableType
{
    /**
     * @var (
     *    'say'
     ...
     * @return CallHookModelResponseTimeoutDoItem
     */
    public static function say(SayHookAction $say): CallHookModelResponseTimeoutDoItem
    {
        return new CallHookModelResponseTimeoutDoItem([
            'type' => 'say',
            'value' => $say,
        ]);
    }
     ...
     * @return CallHookModelResponseTimeoutDoItem
     */
    public static function tool(ToolCallHookAction $tool): CallHookModelResponseTimeoutDoItem
    {
        return new CallHookModelResponseTimeoutDoItem([
            'type' => 'tool',
            'value' => $tool,
     ...
     * @return CallHookModelResponseTimeoutDoItem
     */
    public static function messageAdd(MessageAddHookAction $messageAdd): CallHookModelResponseTimeoutDoItem
    {
        return new CallHookModelResponseTimeoutDoItem([
            'type' => 'message.add',
            'value' => $messageAdd,
