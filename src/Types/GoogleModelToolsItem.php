...
class GoogleModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return GoogleModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): GoogleModelToolsItem
    {
        return new GoogleModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return GoogleModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): GoogleModelToolsItem
    {
        return new GoogleModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return GoogleModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): GoogleModelToolsItem
    {
        return new GoogleModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
