...
class CustomLlmModelToolsItem extends JsonSerializableType
{
     ...
     * @return CustomLlmModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): CustomLlmModelToolsItem
    {
        return new CustomLlmModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return CustomLlmModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): CustomLlmModelToolsItem
    {
        return new CustomLlmModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return CustomLlmModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): CustomLlmModelToolsItem
    {
        return new CustomLlmModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
