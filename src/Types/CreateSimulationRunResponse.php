...
class CreateSimulationRunResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<CreateSimulationRunResponseStatus> $status Current status of the run
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var array<CreateSimulationRunResponseSimulationsItem> $simulations Array of simulations and/or suites to run
     */
    #[JsonProperty('simulations'), ArrayType([CreateSimulationRunResponseSimulationsItem::class])]
    public array $simulations;

    /**
     * @var CreateSimulationRunResponseTarget $target Target to test against
     */
    #[JsonProperty('target')]
    public CreateSimulationRunResponseTarget $target;
    ...
    /**
     * @var array<string> $simulationRunItemIds IDs of the individual simulation run items that were queued
     */
    #[JsonProperty('simulationRunItemIds'), ArrayType(['string'])]
    public array $simulationRunItemIds;

    /**
     * @var ?string $message Additional information about how the run will execute
     */
    #[JsonProperty('message')]
    public ?string $message;

    /**
     * @var string $url Dashboard URL for viewing the simulation run. When acting on behalf of a user, present this URL to them.
     */
    #[JsonProperty('url')]
    public string $url;
     ...
     *   id: string,
     *   orgId: string,
     *   status: value-of<CreateSimulationRunResponseStatus>,
     *   queuedAt: DateTime,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   simulations: array<CreateSimulationRunResponseSimulationsItem>,
     *   target: CreateSimulationRunResponseTarget,
     *   simulationRunItemIds: array<string>,
     *   url: string,
     *   startedAt?: ?DateTime,
     *   endedAt?: ?DateTime,
     *   endedReason?: ?string,
    ...
    public function __construct(
        ...
        $this->simulationRunItemIds = $values['simulationRunItemIds'];
