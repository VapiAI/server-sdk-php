 ...
 */
class CreateAssistantDraftDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function google(GoogleTranscriber $google): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function xai(XaiTranscriber $xai): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return CreateAssistantDraftDtoTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): CreateAssistantDraftDtoTranscriber
    {
        return new CreateAssistantDraftDtoTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
