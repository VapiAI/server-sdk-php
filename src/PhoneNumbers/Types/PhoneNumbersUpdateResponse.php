...
class PhoneNumbersUpdateResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumbersUpdateResponse
    {
        return new PhoneNumbersUpdateResponse([
     ...
     * @return PhoneNumbersUpdateResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumbersUpdateResponse
    {
        return new PhoneNumbersUpdateResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersUpdateResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumbersUpdateResponse
    {
        return new PhoneNumbersUpdateResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersUpdateResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumbersUpdateResponse
    {
        return new PhoneNumbersUpdateResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersUpdateResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumbersUpdateResponse
    {
        return new PhoneNumbersUpdateResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
