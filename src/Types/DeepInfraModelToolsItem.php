...
class DeepInfraModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
