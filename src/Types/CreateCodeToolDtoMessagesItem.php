...
class CreateCodeToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateCodeToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateCodeToolDtoMessagesItem
    {
        return new CreateCodeToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateCodeToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateCodeToolDtoMessagesItem
    {
        return new CreateCodeToolDtoMessagesItem([
     ...
     * @return CreateCodeToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateCodeToolDtoMessagesItem
    {
        return new CreateCodeToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateCodeToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateCodeToolDtoMessagesItem
    {
        return new CreateCodeToolDtoMessagesItem([
