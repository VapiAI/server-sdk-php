...
class AnthropicModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return AnthropicModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
