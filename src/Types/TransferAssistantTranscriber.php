 ...
 */
class TransferAssistantTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return TransferAssistantTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
     ...
     * @return TransferAssistantTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
     ...
     * @return TransferAssistantTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function google(GoogleTranscriber $google): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
     ...
     * @return TransferAssistantTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
     ...
     * @return TransferAssistantTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function xai(XaiTranscriber $xai): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return TransferAssistantTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): TransferAssistantTranscriber
    {
        return new TransferAssistantTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
