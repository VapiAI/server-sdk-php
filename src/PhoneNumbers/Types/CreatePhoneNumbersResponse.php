...
class CreatePhoneNumbersResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): CreatePhoneNumbersResponse
    {
        return new CreatePhoneNumbersResponse([
     ...
     * @return CreatePhoneNumbersResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): CreatePhoneNumbersResponse
    {
        return new CreatePhoneNumbersResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return CreatePhoneNumbersResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): CreatePhoneNumbersResponse
    {
        return new CreatePhoneNumbersResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return CreatePhoneNumbersResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): CreatePhoneNumbersResponse
    {
        return new CreatePhoneNumbersResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return CreatePhoneNumbersResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): CreatePhoneNumbersResponse
    {
        return new CreatePhoneNumbersResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
