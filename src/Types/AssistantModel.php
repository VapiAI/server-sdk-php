 ...
 */
class AssistantModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return AssistantModel
     */
    public static function anthropicBedrock(AnthropicBedrockModel $anthropicBedrock): AssistantModel
    {
        return new AssistantModel([
     ...
     * @return AssistantModel
     */
    public static function minimax(MinimaxLlmModel $minimax): AssistantModel
    {
        return new AssistantModel([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return AssistantModel
     */
    public static function vapi(VapiModel $vapi): AssistantModel
    {
        return new AssistantModel([
            'provider' => 'vapi',
            'value' => $vapi,
