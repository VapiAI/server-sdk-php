...
class CreateAssistantDraftDto extends JsonSerializableType
{
    /**
     * @var ?CreateAssistantDraftDtoTranscriber $transcriber These are the options for the assistant's transcriber.
     */
    #[JsonProperty('transcriber')]
    public ?CreateAssistantDraftDtoTranscriber $transcriber;

    /**
     * @var ?CreateAssistantDraftDtoModel $model These are the options for the assistant's LLM.
     */
    #[JsonProperty('model')]
    public ?CreateAssistantDraftDtoModel $model;

    /**
     * @var ?CreateAssistantDraftDtoVoice $voice These are the options for the assistant's voice.
     */
    #[JsonProperty('voice')]
    public ?CreateAssistantDraftDtoVoice $voice;
     ...
     *
     * @var ?value-of<CreateAssistantDraftDtoFirstMessageMode> $firstMessageMode
     */
     ...
     *
     * @var (
     *    value-of<CreateAssistantDraftDtoVoicemailDetectionZero>
    ...
    /**
     * @var ?array<value-of<CreateAssistantDraftDtoClientMessagesItem>> $clientMessages These are the messages that will be sent to your Client SDKs. Default is conversation-update,function-call,hang,model-output,speech-update,status-update,transfer-update,transcript,tool-calls,user-interrupted,voice-input,workflow.node.started,assistant.started. You can check the shape of the messages in ClientMessage schema.
     */
    #[JsonProperty('clientMessages'), ArrayType(['string'])]
    public ?array $clientMessages;

    /**
     * @var ?array<value-of<CreateAssistantDraftDtoServerMessagesItem>> $serverMessages These are the messages that will be sent to your Server URL. Default is conversation-update,end-of-call-report,function-call,hang,speech-update,status-update,tool-calls,transfer-destination-request,handoff-destination-request,user-interrupted,assistant.started. You can check the shape of the messages in ServerMessage schema.
     */
     ...
     *
     * @var (
     *    value-of<CreateAssistantDraftDtoBackgroundSoundZero>
     *   |string
    ...
    /**
     * @var ?array<CreateAssistantDraftDtoCredentialsItem> $credentials These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
     */
    #[JsonProperty('credentials'), ArrayType([CreateAssistantDraftDtoCredentialsItem::class])]
    ...
    /**
     * @param array{
     *   transcriber?: ?CreateAssistantDraftDtoTranscriber,
     *   model?: ?CreateAssistantDraftDtoModel,
     *   voice?: ?CreateAssistantDraftDtoVoice,
     *   firstMessage?: ?string,
     *   firstMessageInterruptionsEnabled?: ?bool,
     *   firstMessageMode?: ?value-of<CreateAssistantDraftDtoFirstMessageMode>,
     *   voicemailDetection?: (
     *    value-of<CreateAssistantDraftDtoVoicemailDetectionZero>
     *   |GoogleVoicemailDetectionPlan
     *   |OpenAiVoicemailDetectionPlan
     ...
     *   |VapiVoicemailDetectionPlan
     * )|null,
     *   clientMessages?: ?array<value-of<CreateAssistantDraftDtoClientMessagesItem>>,
     *   serverMessages?: ?array<value-of<CreateAssistantDraftDtoServerMessagesItem>>,
     ...
     *   credentials?: ?array<CreateAssistantDraftDtoCredentialsItem>,
     *   hooks?: ?array<(
     *    CallHookCallEnding
     *   |CallHookAssistantSpeechInterrupted
     *   |CallHookCustomerSpeechInterrupted
