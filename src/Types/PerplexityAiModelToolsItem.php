...
class PerplexityAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
