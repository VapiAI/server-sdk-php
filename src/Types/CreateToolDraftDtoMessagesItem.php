...
class CreateToolDraftDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateToolDraftDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateToolDraftDtoMessagesItem
    {
        return new CreateToolDraftDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateToolDraftDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateToolDraftDtoMessagesItem
    {
        return new CreateToolDraftDtoMessagesItem([
     ...
     * @return CreateToolDraftDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateToolDraftDtoMessagesItem
    {
        return new CreateToolDraftDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateToolDraftDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateToolDraftDtoMessagesItem
    {
        return new CreateToolDraftDtoMessagesItem([
