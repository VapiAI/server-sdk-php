...
class SlackWebhookCredential extends JsonSerializableType
{
    /**
     * @var value-of<SlackWebhookCredentialProvider> $provider
     */
    ...
    /**
     * @param array{
     *   provider: value-of<SlackWebhookCredentialProvider>,
     *   webhookUrl: string,
     *   id: string,
     *   orgId: string,
     *   createdAt: DateTime,
