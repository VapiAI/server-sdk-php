...
class CreateToolTemplateDtoDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function code(CreateCodeToolDto $code): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'code',
            'value' => $code,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'voicemail',
            'value' => $voicemail,
