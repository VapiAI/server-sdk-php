 ...
 */
class CreateAssistantDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return CreateAssistantDtoModel
     */
    public static function anthropicBedrock(AnthropicBedrockModel $anthropicBedrock): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
     ...
     * @return CreateAssistantDtoModel
     */
    public static function minimax(MinimaxLlmModel $minimax): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function vapi(VapiModel $vapi): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'vapi',
            'value' => $vapi,
