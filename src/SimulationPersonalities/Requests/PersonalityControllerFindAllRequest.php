...
namespace Vapi\SimulationPersonalities\Requests;

use Vapi\Core\Json\JsonSerializableType;
use Vapi\SimulationPersonalities\Types\PersonalityControllerFindAllRequestSortOrder;
use Vapi\SimulationPersonalities\Types\PersonalityControllerFindAllRequestSortBy;
use DateTime;

class PersonalityControllerFindAllRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PersonalityControllerFindAllRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
    public ?string $sortOrder;

    /**
     * @var ?value-of<PersonalityControllerFindAllRequestSortBy> $sortBy This is the column to sort by. Defaults to 'createdAt'.
     */
     ...
     * @param array{
     *   page?: ?float,
     *   sortOrder?: ?value-of<PersonalityControllerFindAllRequestSortOrder>,
     *   sortBy?: ?value-of<PersonalityControllerFindAllRequestSortBy>,
     *   limit?: ?float,
