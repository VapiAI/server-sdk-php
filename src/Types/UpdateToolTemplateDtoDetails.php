...
class UpdateToolTemplateDtoDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function code(CreateCodeToolDto $code): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'code',
            'value' => $code,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'voicemail',
            'value' => $voicemail,
