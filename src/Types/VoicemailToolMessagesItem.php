...
class VoicemailToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return VoicemailToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): VoicemailToolMessagesItem
    {
        return new VoicemailToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return VoicemailToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): VoicemailToolMessagesItem
    {
        return new VoicemailToolMessagesItem([
     ...
     * @return VoicemailToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): VoicemailToolMessagesItem
    {
        return new VoicemailToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return VoicemailToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): VoicemailToolMessagesItem
    {
        return new VoicemailToolMessagesItem([
