 ...
 */
class ToolNodeTool extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return ToolNodeTool
     */
    public static function code(CreateCodeToolDto $code): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'code',
            'value' => $code,
     ...
     * @return ToolNodeTool
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return ToolNodeTool
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'voicemail',
            'value' => $voicemail,
