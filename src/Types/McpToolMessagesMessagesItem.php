...
class McpToolMessagesMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return McpToolMessagesMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): McpToolMessagesMessagesItem
    {
        return new McpToolMessagesMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return McpToolMessagesMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): McpToolMessagesMessagesItem
    {
        return new McpToolMessagesMessagesItem([
     ...
     * @return McpToolMessagesMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): McpToolMessagesMessagesItem
    {
        return new McpToolMessagesMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return McpToolMessagesMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): McpToolMessagesMessagesItem
    {
        return new McpToolMessagesMessagesItem([
