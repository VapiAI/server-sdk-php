...
use Vapi\Insight\Requests\InsightControllerFindAllRequest;
use Vapi\Types\InsightPaginatedResponse;
...
use Vapi\Insight\Types\InsightControllerCreateRequest;
use Vapi\Insight\Types\InsightControllerCreateResponse;
use Vapi\Insight\Types\InsightControllerFindOneResponse;
use Vapi\Insight\Types\InsightControllerRemoveResponse;
use Vapi\Insight\Requests\InsightControllerUpdateRequest;
use Vapi\Insight\Types\InsightControllerUpdateResponse;
use Vapi\Insight\Requests\InsightRunDto;
use Vapi\Types\InsightRunResponse;
use Vapi\Insight\Types\InsightControllerPreviewRequest;
...
class InsightClient
{
     ...
     * } $options
     * @return ?InsightPaginatedResponse
     * @throws VapiException
     * @throws VapiApiException
     */
    public function insightControllerFindAll(InsightControllerFindAllRequest $request = new InsightControllerFindAllRequest(), ?array $options = null): ?InsightPaginatedResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightPaginatedResponse::fromJson($json);
            }
     ...
     * @throws VapiApiException
     */
    public function insightControllerCreate(InsightControllerCreateRequest $request, ?array $options = null): ?InsightControllerCreateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightControllerCreateResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new VapiException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?InsightControllerFindOneResponse
     * @throws VapiException
     * @throws VapiApiException
     */
    public function insightControllerFindOne(string $id, ?array $options = null): ?InsightControllerFindOneResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightControllerFindOneResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new VapiException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?InsightControllerRemoveResponse
     * @throws VapiException
     * @throws VapiApiException
     */
    public function insightControllerRemove(string $id, ?array $options = null): ?InsightControllerRemoveResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightControllerRemoveResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new VapiException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?InsightControllerUpdateResponse
     * @throws VapiException
     * @throws VapiApiException
     */
    public function insightControllerUpdate(string $id, InsightControllerUpdateRequest $request, ?array $options = null): ?InsightControllerUpdateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightControllerUpdateResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new VapiException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws VapiApiException
     */
    public function insightControllerRun(string $id, InsightRunDto $request = new InsightRunDto(), ?array $options = null): ?InsightRunResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InsightRunResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new VapiException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws VapiApiException
     */
    public function insightControllerPreview(InsightControllerPreviewRequest $request, ?array $options = null): ?InsightRunResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
