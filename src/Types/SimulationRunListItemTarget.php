 ...
 */
class SimulationRunListItemTarget extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return SimulationRunListItemTarget
     */
    public static function assistant(SimulationRunTargetAssistant $assistant): SimulationRunListItemTarget
    {
        return new SimulationRunListItemTarget([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return SimulationRunListItemTarget
     */
    public static function squad(SimulationRunTargetSquad $squad): SimulationRunListItemTarget
    {
        return new SimulationRunListItemTarget([
            'type' => 'squad',
            'value' => $squad,
