...
class FallbackAssemblyAiTranscriber extends JsonSerializableType
{
    ...
    /**
     * @var ?array<value-of<FallbackAssemblyAiTranscriberLanguageCodesItem>> $languageCodes These are language codes used to steer automatic language detection. Only applies to the `universal-3-5-pro` speech model.
     */
