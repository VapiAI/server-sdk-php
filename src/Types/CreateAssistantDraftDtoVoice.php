 ...
 */
class CreateAssistantDraftDtoVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function azure(AzureVoice $azure): CreateAssistantDraftDtoVoice
    {
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function customVoice(CustomVoice $customVoice): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function hume(HumeVoice $hume): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function lmnt(LmntVoice $lmnt): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function openai(OpenAiVoice $openai): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function playht(PlayHtVoice $playht): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function tavus(TavusVoice $tavus): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function vapi(VapiVoice $vapi): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function sesame(SesameVoice $sesame): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function inworld(InworldVoice $inworld): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function minimax(MinimaxVoice $minimax): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function xai(XaiVoice $xai): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return CreateAssistantDraftDtoVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): CreateAssistantDraftDtoVoice
    {
        return new CreateAssistantDraftDtoVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
