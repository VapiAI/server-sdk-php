 ...
 */
class UpdateAssistantDraftDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function google(GoogleTranscriber $google): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function xai(XaiTranscriber $xai): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return UpdateAssistantDraftDtoTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): UpdateAssistantDraftDtoTranscriber
    {
        return new UpdateAssistantDraftDtoTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
