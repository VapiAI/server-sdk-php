...
class InsightControllerCreateRequest extends JsonSerializableType
{
    /**
     * @var (
     *    'bar'
     ...
     * @return InsightControllerCreateRequest
     */
    public static function bar(CreateBarInsightFromCallTableDto $bar): InsightControllerCreateRequest
    {
        return new InsightControllerCreateRequest([
            'type' => 'bar',
            'value' => $bar,
        ]);
    }
     ...
     * @return InsightControllerCreateRequest
     */
    public static function pie(CreatePieInsightFromCallTableDto $pie): InsightControllerCreateRequest
    {
        return new InsightControllerCreateRequest([
            'type' => 'pie',
            'value' => $pie,
     ...
     * @return InsightControllerCreateRequest
     */
    public static function line(CreateLineInsightFromCallTableDto $line): InsightControllerCreateRequest
    {
        return new InsightControllerCreateRequest([
            'type' => 'line',
            'value' => $line,
     ...
     * @return InsightControllerCreateRequest
     */
    public static function text(CreateTextInsightFromCallTableDto $text): InsightControllerCreateRequest
    {
        return new InsightControllerCreateRequest([
            'type' => 'text',
            'value' => $text,
