...
class ConversationNodeToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return ConversationNodeToolsItem
     */
    public static function code(CreateCodeToolDto $code): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
