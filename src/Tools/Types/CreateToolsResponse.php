...
class CreateToolsResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return CreateToolsResponse
     */
    public static function code(CodeTool $code): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'code',
            'value' => $code,
     ...
     * @return CreateToolsResponse
     */
    public static function dtmf(DtmfTool $dtmf): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return CreateToolsResponse
     */
    public static function endCall(EndCallTool $endCall): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return CreateToolsResponse
     */
    public static function function(FunctionTool $function): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return CreateToolsResponse
     */
    public static function knowledgeBase(KnowledgeBaseTool $knowledgeBase): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'knowledgeBase',
            'value' => $knowledgeBase,
     ...
     * @return CreateToolsResponse
     */
    public static function transferCall(TransferCallTool $transferCall): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return CreateToolsResponse
     */
    public static function handoff(HandoffTool $handoff): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return CreateToolsResponse
     */
    public static function bash(BashTool $bash): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return CreateToolsResponse
     */
    public static function computer(ComputerTool $computer): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return CreateToolsResponse
     */
    public static function textEditor(TextEditorTool $textEditor): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return CreateToolsResponse
     */
    public static function query(QueryTool $query): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return CreateToolsResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function sms(SmsTool $sms): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return CreateToolsResponse
     */
    public static function mcp(McpTool $mcp): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return CreateToolsResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): CreateToolsResponse
    {
        return new CreateToolsResponse([
     ...
     * @return CreateToolsResponse
     */
    public static function sipRequest(SipRequestTool $sipRequest): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return CreateToolsResponse
     */
    public static function voicemail(VoicemailTool $voicemail): CreateToolsResponse
    {
        return new CreateToolsResponse([
            'type' => 'voicemail',
            'value' => $voicemail,
