...
class EvalControllerGetPaginatedRequest extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<EvalControllerGetPaginatedRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
    public ?string $sortOrder;

    /**
     * @var ?value-of<EvalControllerGetPaginatedRequestSortBy> $sortBy This is the column to sort by. Defaults to 'createdAt'.
     */
     ...
     *   id?: ?string,
     *   page?: ?float,
     *   sortOrder?: ?value-of<EvalControllerGetPaginatedRequestSortOrder>,
     *   sortBy?: ?value-of<EvalControllerGetPaginatedRequestSortBy>,
     *   limit?: ?float,
