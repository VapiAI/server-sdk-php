...
class XaiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return XaiModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return XaiModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return XaiModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
