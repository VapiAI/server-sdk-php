 ...
 */
class ClientMessageAssistantStartedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageAssistantStartedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageAssistantStartedPhoneNumber
    {
        return new ClientMessageAssistantStartedPhoneNumber([
     ...
     * @return ClientMessageAssistantStartedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageAssistantStartedPhoneNumber
    {
        return new ClientMessageAssistantStartedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageAssistantStartedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageAssistantStartedPhoneNumber
    {
        return new ClientMessageAssistantStartedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageAssistantStartedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageAssistantStartedPhoneNumber
    {
        return new ClientMessageAssistantStartedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageAssistantStartedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageAssistantStartedPhoneNumber
    {
        return new ClientMessageAssistantStartedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
