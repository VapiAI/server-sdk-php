...
class AssistantDraft extends JsonSerializableType
{
    /**
     * @var ?AssistantDraftTranscriber $transcriber These are the options for the assistant's transcriber.
     */
    #[JsonProperty('transcriber')]
    public ?AssistantDraftTranscriber $transcriber;

    /**
     * @var ?AssistantDraftModel $model These are the options for the assistant's LLM.
     */
    #[JsonProperty('model')]
    public ?AssistantDraftModel $model;

    /**
     * @var ?AssistantDraftVoice $voice These are the options for the assistant's voice.
     */
    #[JsonProperty('voice')]
    public ?AssistantDraftVoice $voice;
     ...
     *
     * @var ?value-of<AssistantDraftFirstMessageMode> $firstMessageMode
     */
     ...
     *
     * @var (
     *    value-of<AssistantDraftVoicemailDetectionZero>
    ...
    /**
     * @var ?array<value-of<AssistantDraftClientMessagesItem>> $clientMessages These are the messages that will be sent to your Client SDKs. Default is conversation-update,function-call,hang,model-output,speech-update,status-update,transfer-update,transcript,tool-calls,user-interrupted,voice-input,workflow.node.started,assistant.started. You can check the shape of the messages in ClientMessage schema.
     */
    #[JsonProperty('clientMessages'), ArrayType(['string'])]
    public ?array $clientMessages;

    /**
     * @var ?array<value-of<AssistantDraftServerMessagesItem>> $serverMessages These are the messages that will be sent to your Server URL. Default is conversation-update,end-of-call-report,function-call,hang,speech-update,status-update,tool-calls,transfer-destination-request,handoff-destination-request,user-interrupted,assistant.started. You can check the shape of the messages in ServerMessage schema.
     */
     ...
     *
     * @var (
     *    value-of<AssistantDraftBackgroundSoundZero>
     *   |string
    ...
    /**
     * @var ?array<AssistantDraftCredentialsItem> $credentials These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
     */
     ...
     *   firstMessageMode?: ?value-of<AssistantDraftFirstMessageMode>,
     *   voicemailDetection?: (
     *    value-of<AssistantDraftVoicemailDetectionZero>
     *   |GoogleVoicemailDetectionPlan
     *   |OpenAiVoicemailDetectionPlan
     ...
     *   |VapiVoicemailDetectionPlan
     * )|null,
     *   clientMessages?: ?array<value-of<AssistantDraftClientMessagesItem>>,
     *   serverMessages?: ?array<value-of<AssistantDraftServerMessagesItem>>,
     ...
     *   credentials?: ?array<AssistantDraftCredentialsItem>,
     *   hooks?: ?array<(
     *    CallHookCallEnding
     *   |CallHookAssistantSpeechInterrupted
     *   |CallHookCustomerSpeechInterrupted
