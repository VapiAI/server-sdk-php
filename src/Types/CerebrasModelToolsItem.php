...
class CerebrasModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return CerebrasModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
