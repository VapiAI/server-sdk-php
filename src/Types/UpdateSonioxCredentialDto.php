...
class UpdateSonioxCredentialDto extends JsonSerializableType
{
    /**
     * @var ?value-of<UpdateSonioxCredentialDtoProvider> $provider
     */
    ...
    /**
     * @param array{
     *   provider?: ?value-of<UpdateSonioxCredentialDtoProvider>,
     *   apiKey?: ?string,
     *   apiUrl?: ?string,
     *   name?: ?string,
     * } $values
