 ...
 */
class RecordingConsentPlanStayOnLineVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function xai(XaiVoice $xai): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
