...
class UpdateKnowledgeBaseToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateKnowledgeBaseToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateKnowledgeBaseToolDtoMessagesItem
    {
        return new UpdateKnowledgeBaseToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateKnowledgeBaseToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateKnowledgeBaseToolDtoMessagesItem
    {
        return new UpdateKnowledgeBaseToolDtoMessagesItem([
     ...
     * @return UpdateKnowledgeBaseToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateKnowledgeBaseToolDtoMessagesItem
    {
        return new UpdateKnowledgeBaseToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateKnowledgeBaseToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateKnowledgeBaseToolDtoMessagesItem
    {
        return new UpdateKnowledgeBaseToolDtoMessagesItem([
