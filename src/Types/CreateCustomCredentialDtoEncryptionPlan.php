 ...
 */
class CreateCustomCredentialDtoEncryptionPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'public-key'
     ...
     * @return CreateCustomCredentialDtoEncryptionPlan
     */
    public static function publicKey(PublicKeyEncryptionPlan $publicKey): CreateCustomCredentialDtoEncryptionPlan
    {
        return new CreateCustomCredentialDtoEncryptionPlan([
            'type' => 'public-key',
            'value' => $publicKey,
        ]);
    }
