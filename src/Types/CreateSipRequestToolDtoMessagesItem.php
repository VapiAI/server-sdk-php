...
class CreateSipRequestToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateSipRequestToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateSipRequestToolDtoMessagesItem
    {
        return new CreateSipRequestToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateSipRequestToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateSipRequestToolDtoMessagesItem
    {
        return new CreateSipRequestToolDtoMessagesItem([
     ...
     * @return CreateSipRequestToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateSipRequestToolDtoMessagesItem
    {
        return new CreateSipRequestToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateSipRequestToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateSipRequestToolDtoMessagesItem
    {
        return new CreateSipRequestToolDtoMessagesItem([
