 ...
 */
class UpdateAssistantDraftDtoVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function azure(AzureVoice $azure): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function customVoice(CustomVoice $customVoice): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function hume(HumeVoice $hume): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function lmnt(LmntVoice $lmnt): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function openai(OpenAiVoice $openai): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function playht(PlayHtVoice $playht): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function tavus(TavusVoice $tavus): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function vapi(VapiVoice $vapi): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function sesame(SesameVoice $sesame): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function inworld(InworldVoice $inworld): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function minimax(MinimaxVoice $minimax): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function xai(XaiVoice $xai): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return UpdateAssistantDraftDtoVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): UpdateAssistantDraftDtoVoice
    {
        return new UpdateAssistantDraftDtoVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
