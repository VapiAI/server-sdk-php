...
class MinimaxLlmModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return MinimaxLlmModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): MinimaxLlmModelToolsItem
    {
        return new MinimaxLlmModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
