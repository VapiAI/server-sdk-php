...
class InsightControllerFindOneResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'bar'
     ...
     */
    public static function bar(BarInsight $bar): InsightControllerFindOneResponse
    {
        return new InsightControllerFindOneResponse([
            'type' => 'bar',
            'value' => $bar,
        ]);
    }
     ...
     * @return InsightControllerFindOneResponse
     */
    public static function pie(PieInsight $pie): InsightControllerFindOneResponse
    {
        return new InsightControllerFindOneResponse([
            'type' => 'pie',
            'value' => $pie,
     ...
     * @return InsightControllerFindOneResponse
     */
    public static function line(LineInsight $line): InsightControllerFindOneResponse
    {
        return new InsightControllerFindOneResponse([
            'type' => 'line',
            'value' => $line,
     ...
     * @return InsightControllerFindOneResponse
     */
    public static function text(TextInsight $text): InsightControllerFindOneResponse
    {
        return new InsightControllerFindOneResponse([
            'type' => 'text',
            'value' => $text,
