...
class AssistantOverridesCredentialsItem extends JsonSerializableType
{
    /**
     * @var (
     *    '11labs'
     ...
     * @return AssistantOverridesCredentialsItem
     */
    public static function anthropicBedrock(CreateAnthropicBedrockCredentialDto $anthropicBedrock): AssistantOverridesCredentialsItem
    {
        return new AssistantOverridesCredentialsItem([
     ...
     * @return AssistantOverridesCredentialsItem
     */
    public static function soniox(CreateSonioxCredentialDto $soniox): AssistantOverridesCredentialsItem
    {
        return new AssistantOverridesCredentialsItem([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return AssistantOverridesCredentialsItem
     */
    public static function wellsaid(CreateWellSaidCredentialDto $wellsaid): AssistantOverridesCredentialsItem
    {
        return new AssistantOverridesCredentialsItem([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return AssistantOverridesCredentialsItem
     */
    public static function email(CreateEmailCredentialDto $email): AssistantOverridesCredentialsItem
    {
        return new AssistantOverridesCredentialsItem([
            'provider' => 'email',
            'value' => $email,
     ...
     * @return AssistantOverridesCredentialsItem
     */
    public static function slackWebhook(CreateSlackWebhookCredentialDto $slackWebhook): AssistantOverridesCredentialsItem
    {
        return new AssistantOverridesCredentialsItem([
