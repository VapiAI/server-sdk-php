 ...
 */
class UpdateVoicemailToolDto extends JsonSerializableType
{
    /**
     * @var ?array<UpdateVoicemailToolDtoMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
    #[JsonProperty('messages'), ArrayType([UpdateVoicemailToolDtoMessagesItem::class])]
    ...
    /**
     * @param array{
     *   messages?: ?array<UpdateVoicemailToolDtoMessagesItem>,
