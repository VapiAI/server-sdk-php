...
class ToolDraftMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return ToolDraftMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): ToolDraftMessagesItem
    {
        return new ToolDraftMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return ToolDraftMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ToolDraftMessagesItem
    {
        return new ToolDraftMessagesItem([
     ...
     * @return ToolDraftMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ToolDraftMessagesItem
    {
        return new ToolDraftMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return ToolDraftMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): ToolDraftMessagesItem
    {
        return new ToolDraftMessagesItem([
