 ...
 */
class CreateComputerToolDto extends JsonSerializableType
{
    /**
     * @var ?array<CreateComputerToolDtoMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
    #[JsonProperty('messages'), ArrayType([CreateComputerToolDtoMessagesItem::class])]
    public ?array $messages;

    /**
     * @var value-of<CreateComputerToolDtoSubType> $subType The sub type of tool.
     */
    ...
    /**
     * @var value-of<CreateComputerToolDtoName> $name The name of the tool, fixed to 'computer'
     */
    #[JsonProperty('name')]
    public string $name;
    ...
    /**
     * @param array{
     *   subType: value-of<CreateComputerToolDtoSubType>,
     *   name: value-of<CreateComputerToolDtoName>,
