...
class OpenAiVoicemailDetectionPlan extends JsonSerializableType
{
    ...
    /**
     * @var value-of<OpenAiVoicemailDetectionPlanProvider> $provider This is the provider to use for voicemail detection.
     */
    ...
    /**
     * @param array{
     *   provider: value-of<OpenAiVoicemailDetectionPlanProvider>,
