 ...
 */
class AnthropicBedrockCredentialAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'aws-iam'
     ...
     * @return AnthropicBedrockCredentialAuthenticationPlan
     */
    public static function awsIam(AwsiamCredentialsAuthenticationPlan $awsIam): AnthropicBedrockCredentialAuthenticationPlan
    {
        return new AnthropicBedrockCredentialAuthenticationPlan([
            'type' => 'aws-iam',
            'value' => $awsIam,
        ]);
    }
     ...
     * @return AnthropicBedrockCredentialAuthenticationPlan
     */
    public static function awsSts(AwsStsAuthenticationPlan $awsSts): AnthropicBedrockCredentialAuthenticationPlan
    {
        return new AnthropicBedrockCredentialAuthenticationPlan([
            'type' => 'aws-sts',
            'value' => $awsSts,
