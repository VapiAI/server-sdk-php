...
class ClientMessage extends JsonSerializableType
{
     ...
     */
    #[JsonProperty('message'), Union(ClientMessageWorkflowNodeStarted::class, ClientMessageAssistantStarted::class, ClientMessageConversationUpdate::class, ClientMessageHang::class, ClientMessageMetadata::class, ClientMessageModelOutput::class, ClientMessageSpeechUpdate::class, ClientMessageTranscript::class, ClientMessageToolCalls::class, ClientMessageToolCallsResult::class, ClientMessageTransferUpdate::class, ClientMessageUserInterrupted::class, ClientMessageLanguageChangeDetected::class, ClientMessageVoiceInput::class, ClientMessageAssistantSpeech::class, ClientMessageChatCreated::class, ClientMessageChatDeleted::class, ClientMessageSessionCreated::class, ClientMessageSessionUpdated::class, ClientMessageSessionDeleted::class, ClientMessageCallDeleted::class, ClientMessageCallDeleteFailed::class)]
    public ClientMessageWorkflowNodeStarted|ClientMessageAssistantStarted|ClientMessageConversationUpdate|ClientMessageHang|ClientMessageMetadata|ClientMessageModelOutput|ClientMessageSpeechUpdate|ClientMessageTranscript|ClientMessageToolCalls|ClientMessageToolCallsResult|ClientMessageTransferUpdate|ClientMessageUserInterrupted|ClientMessageLanguageChangeDetected|ClientMessageVoiceInput|ClientMessageAssistantSpeech|ClientMessageChatCreated|ClientMessageChatDeleted|ClientMessageSessionCreated|ClientMessageSessionUpdated|ClientMessageSessionDeleted|ClientMessageCallDeleted|ClientMessageCallDeleteFailed $message;
