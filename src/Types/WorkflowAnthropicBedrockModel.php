...
class WorkflowAnthropicBedrockModel extends JsonSerializableType
{
    /**
     * @var value-of<WorkflowAnthropicBedrockModelModel> $model This is the specific model that will be used.
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<WorkflowAnthropicBedrockModelModel>,
