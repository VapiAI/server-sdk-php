...
class CreateStructuredOutputDtoConditionsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'minMessages'
     ...
     */
    public static function minMessages(MinMessagesCondition $minMessages): CreateStructuredOutputDtoConditionsItem
    {
        return new CreateStructuredOutputDtoConditionsItem([
            'type' => 'minMessages',
            'value' => $minMessages,
        ]);
    }
     ...
     * @return CreateStructuredOutputDtoConditionsItem
     */
    public static function minCallDuration(MinCallDurationCondition $minCallDuration): CreateStructuredOutputDtoConditionsItem
    {
        return new CreateStructuredOutputDtoConditionsItem([
     ...
     * @return CreateStructuredOutputDtoConditionsItem
     */
    public static function endedReason(EndedReasonCondition $endedReason): CreateStructuredOutputDtoConditionsItem
    {
        return new CreateStructuredOutputDtoConditionsItem([
            'type' => 'endedReason',
            'value' => $endedReason,
