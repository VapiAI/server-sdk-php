 ...
 */
class AssistantVersionModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return AssistantVersionModel
     */
    public static function anthropic(AnthropicModel $anthropic): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
        ]);
    }
     ...
     * @return AssistantVersionModel
     */
    public static function anthropicBedrock(AnthropicBedrockModel $anthropicBedrock): AssistantVersionModel
    {
        return new AssistantVersionModel([
     ...
     * @return AssistantVersionModel
     */
    public static function anyscale(AnyscaleModel $anyscale): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return AssistantVersionModel
     */
    public static function cerebras(CerebrasModel $cerebras): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return AssistantVersionModel
     */
    public static function customLlm(CustomLlmModel $customLlm): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return AssistantVersionModel
     */
    public static function deepinfra(DeepInfraModel $deepinfra): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return AssistantVersionModel
     */
    public static function deepSeek(DeepSeekModel $deepSeek): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return AssistantVersionModel
     */
    public static function google(GoogleModel $google): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return AssistantVersionModel
     */
    public static function groq(GroqModel $groq): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return AssistantVersionModel
     */
    public static function inflectionAi(InflectionAiModel $inflectionAi): AssistantVersionModel
    {
        return new AssistantVersionModel([
     ...
     * @return AssistantVersionModel
     */
    public static function minimax(MinimaxLlmModel $minimax): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return AssistantVersionModel
     */
    public static function openai(OpenAiModel $openai): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantVersionModel
     */
    public static function openrouter(OpenRouterModel $openrouter): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return AssistantVersionModel
     */
    public static function perplexityAi(PerplexityAiModel $perplexityAi): AssistantVersionModel
    {
        return new AssistantVersionModel([
     ...
     * @return AssistantVersionModel
     */
    public static function togetherAi(TogetherAiModel $togetherAi): AssistantVersionModel
    {
        return new AssistantVersionModel([
     ...
     * @return AssistantVersionModel
     */
    public static function xai(XaiModel $xai): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return AssistantVersionModel
     */
    public static function vapi(VapiModel $vapi): AssistantVersionModel
    {
        return new AssistantVersionModel([
            'provider' => 'vapi',
            'value' => $vapi,
