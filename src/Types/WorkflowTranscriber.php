 ...
 */
class WorkflowTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return WorkflowTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return WorkflowTranscriber
     */
    public static function xai(XaiTranscriber $xai): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return WorkflowTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
