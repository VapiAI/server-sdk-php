...
class UpdateCodeToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateCodeToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateCodeToolDtoMessagesItem
    {
        return new UpdateCodeToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateCodeToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateCodeToolDtoMessagesItem
    {
        return new UpdateCodeToolDtoMessagesItem([
     ...
     * @return UpdateCodeToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateCodeToolDtoMessagesItem
    {
        return new UpdateCodeToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateCodeToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateCodeToolDtoMessagesItem
    {
        return new UpdateCodeToolDtoMessagesItem([
