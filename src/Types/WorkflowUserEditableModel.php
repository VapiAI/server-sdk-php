 ...
 */
class WorkflowUserEditableModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return WorkflowUserEditableModel
     */
    public static function anthropicBedrock(WorkflowAnthropicBedrockModel $anthropicBedrock): WorkflowUserEditableModel
    {
        return new WorkflowUserEditableModel([
