...
class PhoneNumbersGetResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumbersGetResponse
    {
        return new PhoneNumbersGetResponse([
     ...
     * @return PhoneNumbersGetResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumbersGetResponse
    {
        return new PhoneNumbersGetResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersGetResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumbersGetResponse
    {
        return new PhoneNumbersGetResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersGetResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumbersGetResponse
    {
        return new PhoneNumbersGetResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersGetResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumbersGetResponse
    {
        return new PhoneNumbersGetResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
