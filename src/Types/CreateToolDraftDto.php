...
class CreateToolDraftDto extends JsonSerializableType
{
    /**
     * @var ?array<CreateToolDraftDtoMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
    #[JsonProperty('messages'), ArrayType([CreateToolDraftDtoMessagesItem::class])]
    public ?array $messages;

    /**
     * @var ?value-of<CreateToolDraftDtoType> $type This is the type of the tool.
     */
    #[JsonProperty('type')]
    public ?string $type;
    ...
    /**
     * @var ?value-of<CreateToolDraftDtoMethod> $method This is the HTTP method for the request (api-request tool).
     */
    #[JsonProperty('method')]
    ...
    /**
     * @var ?value-of<CreateToolDraftDtoVerb> $verb This is the SIP method to send (sip-request tool).
     */
    #[JsonProperty('verb')]
    public ?string $verb;
    ...
    /**
     * @param array{
     *   messages?: ?array<CreateToolDraftDtoMessagesItem>,
     *   type?: ?value-of<CreateToolDraftDtoType>,
     *   baseVersion?: ?string,
     ...
     *   url?: ?string,
     *   method?: ?value-of<CreateToolDraftDtoMethod>,
     *   headers?: ?JsonSchema,
     ...
     *   verb?: ?value-of<CreateToolDraftDtoVerb>,
    ...
    public function __construct(
        ...
        $this->baseVersion = $values['baseVersion'] ?? null;
