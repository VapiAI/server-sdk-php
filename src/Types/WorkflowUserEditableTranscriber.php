 ...
 */
class WorkflowUserEditableTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function xai(XaiTranscriber $xai): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
