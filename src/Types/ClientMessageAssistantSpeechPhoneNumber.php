 ...
 */
class ClientMessageAssistantSpeechPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageAssistantSpeechPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageAssistantSpeechPhoneNumber
    {
        return new ClientMessageAssistantSpeechPhoneNumber([
     ...
     * @return ClientMessageAssistantSpeechPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageAssistantSpeechPhoneNumber
    {
        return new ClientMessageAssistantSpeechPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageAssistantSpeechPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageAssistantSpeechPhoneNumber
    {
        return new ClientMessageAssistantSpeechPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageAssistantSpeechPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageAssistantSpeechPhoneNumber
    {
        return new ClientMessageAssistantSpeechPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageAssistantSpeechPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageAssistantSpeechPhoneNumber
    {
        return new ClientMessageAssistantSpeechPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
