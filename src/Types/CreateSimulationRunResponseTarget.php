 ...
 */
class CreateSimulationRunResponseTarget extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return CreateSimulationRunResponseTarget
     */
    public static function assistant(SimulationRunTargetAssistant $assistant): CreateSimulationRunResponseTarget
    {
        return new CreateSimulationRunResponseTarget([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return CreateSimulationRunResponseTarget
     */
    public static function squad(SimulationRunTargetSquad $squad): CreateSimulationRunResponseTarget
    {
        return new CreateSimulationRunResponseTarget([
            'type' => 'squad',
            'value' => $squad,
