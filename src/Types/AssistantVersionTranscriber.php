 ...
 */
class AssistantVersionTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return AssistantVersionTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
     ...
     * @return AssistantVersionTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
     ...
     * @return AssistantVersionTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function google(GoogleTranscriber $google): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
     ...
     * @return AssistantVersionTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
     ...
     * @return AssistantVersionTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function xai(XaiTranscriber $xai): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return AssistantVersionTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): AssistantVersionTranscriber
    {
        return new AssistantVersionTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
