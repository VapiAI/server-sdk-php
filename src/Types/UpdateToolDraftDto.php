...
class UpdateToolDraftDto extends JsonSerializableType
{
    /**
     * @var ?array<UpdateToolDraftDtoMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
    #[JsonProperty('messages'), ArrayType([UpdateToolDraftDtoMessagesItem::class])]
    public ?array $messages;

    /**
     * @var ?value-of<UpdateToolDraftDtoType> $type This is the type of the tool.
     */
    #[JsonProperty('type')]
    public ?string $type;
    ...
    /**
     * @var ?value-of<UpdateToolDraftDtoMethod> $method This is the HTTP method for the request (api-request tool).
     */
    #[JsonProperty('method')]
    ...
    /**
     * @var ?value-of<UpdateToolDraftDtoVerb> $verb This is the SIP method to send (sip-request tool).
     */
    #[JsonProperty('verb')]
    public ?string $verb;
    ...
    /**
     * @param array{
     *   messages?: ?array<UpdateToolDraftDtoMessagesItem>,
     *   type?: ?value-of<UpdateToolDraftDtoType>,
     ...
     *   url?: ?string,
     *   method?: ?value-of<UpdateToolDraftDtoMethod>,
     *   headers?: ?JsonSchema,
     ...
     *   verb?: ?value-of<UpdateToolDraftDtoVerb>,
