 ...
 */
class SkippedStructuredOutputUnmetCondition extends JsonSerializableType
{
    /**
     * @var (
     *    'minMessages'
     ...
     * @return SkippedStructuredOutputUnmetCondition
     */
    public static function minMessages(MinMessagesCondition $minMessages): SkippedStructuredOutputUnmetCondition
    {
        return new SkippedStructuredOutputUnmetCondition([
            'type' => 'minMessages',
            'value' => $minMessages,
        ]);
    }
     ...
     * @return SkippedStructuredOutputUnmetCondition
     */
    public static function minCallDuration(MinCallDurationCondition $minCallDuration): SkippedStructuredOutputUnmetCondition
    {
        return new SkippedStructuredOutputUnmetCondition([
     ...
     * @return SkippedStructuredOutputUnmetCondition
     */
    public static function endedReason(EndedReasonCondition $endedReason): SkippedStructuredOutputUnmetCondition
    {
        return new SkippedStructuredOutputUnmetCondition([
            'type' => 'endedReason',
            'value' => $endedReason,
