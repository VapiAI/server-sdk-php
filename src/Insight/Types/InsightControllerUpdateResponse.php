...
class InsightControllerUpdateResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'bar'
     ...
     */
    public static function bar(BarInsight $bar): InsightControllerUpdateResponse
    {
        return new InsightControllerUpdateResponse([
            'type' => 'bar',
            'value' => $bar,
        ]);
    }
     ...
     * @return InsightControllerUpdateResponse
     */
    public static function pie(PieInsight $pie): InsightControllerUpdateResponse
    {
        return new InsightControllerUpdateResponse([
            'type' => 'pie',
            'value' => $pie,
     ...
     * @return InsightControllerUpdateResponse
     */
    public static function line(LineInsight $line): InsightControllerUpdateResponse
    {
        return new InsightControllerUpdateResponse([
            'type' => 'line',
            'value' => $line,
     ...
     * @return InsightControllerUpdateResponse
     */
    public static function text(TextInsight $text): InsightControllerUpdateResponse
    {
        return new InsightControllerUpdateResponse([
            'type' => 'text',
            'value' => $text,
