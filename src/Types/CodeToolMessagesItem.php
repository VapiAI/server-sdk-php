...
class CodeToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CodeToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CodeToolMessagesItem
    {
        return new CodeToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CodeToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CodeToolMessagesItem
    {
        return new CodeToolMessagesItem([
     ...
     * @return CodeToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CodeToolMessagesItem
    {
        return new CodeToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CodeToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CodeToolMessagesItem
    {
        return new CodeToolMessagesItem([
