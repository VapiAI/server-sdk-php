 ...
 */
class UpdateWorkflowDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return UpdateWorkflowDtoModel
     */
    public static function anthropicBedrock(WorkflowAnthropicBedrockModel $anthropicBedrock): UpdateWorkflowDtoModel
    {
        return new UpdateWorkflowDtoModel([
