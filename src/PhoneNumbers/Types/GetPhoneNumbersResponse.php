...
class GetPhoneNumbersResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): GetPhoneNumbersResponse
    {
     ...
     * @return GetPhoneNumbersResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): GetPhoneNumbersResponse
    {
        return new GetPhoneNumbersResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return GetPhoneNumbersResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): GetPhoneNumbersResponse
    {
        return new GetPhoneNumbersResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return GetPhoneNumbersResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): GetPhoneNumbersResponse
    {
        return new GetPhoneNumbersResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return GetPhoneNumbersResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): GetPhoneNumbersResponse
    {
        return new GetPhoneNumbersResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
