 ...
 */
class HandoffDestinationSquadContextEngineeringPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'lastNMessages'
     ...
     */
    public static function lastNMessages(ContextEngineeringPlanLastNMessages $lastNMessages): HandoffDestinationSquadContextEngineeringPlan
    {
     ...
     * @return HandoffDestinationSquadContextEngineeringPlan
     */
    public static function none(ContextEngineeringPlanNone $none): HandoffDestinationSquadContextEngineeringPlan
    {
        return new HandoffDestinationSquadContextEngineeringPlan([
            'type' => 'none',
            'value' => $none,
     ...
     * @return HandoffDestinationSquadContextEngineeringPlan
     */
    public static function all(ContextEngineeringPlanAll $all): HandoffDestinationSquadContextEngineeringPlan
    {
        return new HandoffDestinationSquadContextEngineeringPlan([
            'type' => 'all',
            'value' => $all,
     ...
     * @return HandoffDestinationSquadContextEngineeringPlan
     */
    public static function userAndAssistantMessages(ContextEngineeringPlanUserAndAssistantMessages $userAndAssistantMessages): HandoffDestinationSquadContextEngineeringPlan
    {
        return new HandoffDestinationSquadContextEngineeringPlan([
