 ...
 */
class WorkflowVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return WorkflowVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return WorkflowVoice
     */
    public static function xai(XaiVoice $xai): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return WorkflowVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
