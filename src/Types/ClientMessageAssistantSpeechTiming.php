 ...
 */
class ClientMessageAssistantSpeechTiming extends JsonSerializableType
{
    /**
     * @var (
     *    'word-alignment'
     ...
     * @return ClientMessageAssistantSpeechTiming
     */
    public static function wordAlignment(AssistantSpeechWordAlignmentTiming $wordAlignment): ClientMessageAssistantSpeechTiming
    {
        return new ClientMessageAssistantSpeechTiming([
            'type' => 'word-alignment',
            'value' => $wordAlignment,
        ]);
    }
     ...
     * @return ClientMessageAssistantSpeechTiming
     */
    public static function wordProgress(AssistantSpeechWordProgressTiming $wordProgress): ClientMessageAssistantSpeechTiming
    {
        return new ClientMessageAssistantSpeechTiming([
            'type' => 'word-progress',
            'value' => $wordProgress,
