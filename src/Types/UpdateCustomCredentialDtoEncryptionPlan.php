 ...
 */
class UpdateCustomCredentialDtoEncryptionPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'public-key'
     ...
     * @return UpdateCustomCredentialDtoEncryptionPlan
     */
    public static function publicKey(PublicKeyEncryptionPlan $publicKey): UpdateCustomCredentialDtoEncryptionPlan
    {
        return new UpdateCustomCredentialDtoEncryptionPlan([
            'type' => 'public-key',
            'value' => $publicKey,
        ]);
    }
