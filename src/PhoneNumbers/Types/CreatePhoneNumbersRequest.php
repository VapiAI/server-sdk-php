...
class CreatePhoneNumbersRequest extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return CreatePhoneNumbersRequest
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): CreatePhoneNumbersRequest
    {
        return new CreatePhoneNumbersRequest([
     ...
     * @return CreatePhoneNumbersRequest
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): CreatePhoneNumbersRequest
    {
        return new CreatePhoneNumbersRequest([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return CreatePhoneNumbersRequest
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): CreatePhoneNumbersRequest
    {
        return new CreatePhoneNumbersRequest([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return CreatePhoneNumbersRequest
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): CreatePhoneNumbersRequest
    {
        return new CreatePhoneNumbersRequest([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return CreatePhoneNumbersRequest
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): CreatePhoneNumbersRequest
    {
        return new CreatePhoneNumbersRequest([
            'provider' => 'telnyx',
            'value' => $telnyx,
