 ...
 */
class CerebrasModel extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<CerebrasModelModel> $model The Cerebras model used to generate assistant responses. `llama-3.3-70b` is deprecated and no longer available in the Dashboard.
     */
    #[JsonProperty('model')]
    public string $model;
