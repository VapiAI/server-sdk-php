...
class DeleteToolsResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): DeleteToolsResponse
    {
     ...
     * @return DeleteToolsResponse
     */
    public static function code(CodeTool $code): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'code',
            'value' => $code,
     ...
     * @return DeleteToolsResponse
     */
    public static function dtmf(DtmfTool $dtmf): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return DeleteToolsResponse
     */
    public static function endCall(EndCallTool $endCall): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return DeleteToolsResponse
     */
    public static function function(FunctionTool $function): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return DeleteToolsResponse
     */
    public static function transferCall(TransferCallTool $transferCall): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return DeleteToolsResponse
     */
    public static function handoff(HandoffTool $handoff): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return DeleteToolsResponse
     */
    public static function bash(BashTool $bash): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return DeleteToolsResponse
     */
    public static function computer(ComputerTool $computer): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return DeleteToolsResponse
     */
    public static function textEditor(TextEditorTool $textEditor): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return DeleteToolsResponse
     */
    public static function query(QueryTool $query): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return DeleteToolsResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function sms(SmsTool $sms): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return DeleteToolsResponse
     */
    public static function mcp(McpTool $mcp): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return DeleteToolsResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
     ...
     * @return DeleteToolsResponse
     */
    public static function sipRequest(SipRequestTool $sipRequest): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return DeleteToolsResponse
     */
    public static function voicemail(VoicemailTool $voicemail): DeleteToolsResponse
    {
        return new DeleteToolsResponse([
            'type' => 'voicemail',
            'value' => $voicemail,
