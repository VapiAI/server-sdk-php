...
{
    /**
     * @var ?array<UpdateTextEditorToolDtoMessagesItem> $messages Messages spoken while the tool is running. Multiple request-start messages are variants. For request-response-delayed, same timing means variants and different timings mean staged updates.
     */
    #[JsonProperty('messages'), ArrayType([UpdateTextEditorToolDtoMessagesItem::class])]
    public ?array $messages;

    /**
     * @var ?value-of<UpdateTextEditorToolDtoSubType> $subType The sub type of tool.
     */
    ...
    /**
     * @var ?value-of<UpdateTextEditorToolDtoName> $name The name of the tool, fixed to 'str_replace_editor'
     */
    #[JsonProperty('name')]
    public ?string $name;
     ...
     *   subType?: ?value-of<UpdateTextEditorToolDtoSubType>,
     *   server?: ?Server,
     *   rejectionPlan?: ?ToolRejectionPlan,
     *   name?: ?value-of<UpdateTextEditorToolDtoName>,
     * } $values
     */
