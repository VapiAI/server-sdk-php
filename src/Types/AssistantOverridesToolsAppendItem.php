...
class AssistantOverridesToolsAppendItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function bash(CreateBashToolDto $bash): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function code(CreateCodeToolDto $code): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function computer(CreateComputerToolDto $computer): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function function(CreateFunctionToolDto $function): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function mcp(CreateMcpToolDto $mcp): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function query(CreateQueryToolDto $query): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function sms(CreateSmsToolDto $sms): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return AssistantOverridesToolsAppendItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): AssistantOverridesToolsAppendItem
    {
        return new AssistantOverridesToolsAppendItem([
            'type' => 'voicemail',
            'value' => $voicemail,
