...
class UpdateVoicemailToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateVoicemailToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateVoicemailToolDtoMessagesItem
    {
        return new UpdateVoicemailToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateVoicemailToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateVoicemailToolDtoMessagesItem
    {
        return new UpdateVoicemailToolDtoMessagesItem([
     ...
     * @return UpdateVoicemailToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateVoicemailToolDtoMessagesItem
    {
        return new UpdateVoicemailToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateVoicemailToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateVoicemailToolDtoMessagesItem
    {
        return new UpdateVoicemailToolDtoMessagesItem([
