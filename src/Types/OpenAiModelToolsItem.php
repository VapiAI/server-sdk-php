...
class OpenAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return OpenAiModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
