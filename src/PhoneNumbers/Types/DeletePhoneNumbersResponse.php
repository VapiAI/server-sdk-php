...
class DeletePhoneNumbersResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): DeletePhoneNumbersResponse
    {
        return new DeletePhoneNumbersResponse([
     ...
     * @return DeletePhoneNumbersResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): DeletePhoneNumbersResponse
    {
        return new DeletePhoneNumbersResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return DeletePhoneNumbersResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): DeletePhoneNumbersResponse
    {
        return new DeletePhoneNumbersResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return DeletePhoneNumbersResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): DeletePhoneNumbersResponse
    {
        return new DeletePhoneNumbersResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return DeletePhoneNumbersResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): DeletePhoneNumbersResponse
    {
        return new DeletePhoneNumbersResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
