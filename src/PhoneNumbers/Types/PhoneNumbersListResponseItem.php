...
class PhoneNumbersListResponseItem extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return PhoneNumbersListResponseItem
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumbersListResponseItem
    {
        return new PhoneNumbersListResponseItem([
     ...
     * @return PhoneNumbersListResponseItem
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumbersListResponseItem
    {
        return new PhoneNumbersListResponseItem([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersListResponseItem
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumbersListResponseItem
    {
        return new PhoneNumbersListResponseItem([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersListResponseItem
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumbersListResponseItem
    {
        return new PhoneNumbersListResponseItem([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersListResponseItem
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumbersListResponseItem
    {
        return new PhoneNumbersListResponseItem([
            'provider' => 'telnyx',
            'value' => $telnyx,
