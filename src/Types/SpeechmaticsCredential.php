...
class SpeechmaticsCredential extends JsonSerializableType
{
    /**
     * @var value-of<SpeechmaticsCredentialProvider> $provider
     */
    ...
    /**
     * @param array{
     *   provider: value-of<SpeechmaticsCredentialProvider>,
     *   apiKey: string,
     *   id: string,
     *   orgId: string,
     *   createdAt: DateTime,
