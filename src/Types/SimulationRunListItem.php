...
class SimulationRunListItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<SimulationRunListItemStatus> $status Current status of the run
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var array<SimulationRunListItemSimulationsItem> $simulations Array of simulations and/or suites to run
     */
    #[JsonProperty('simulations'), ArrayType([SimulationRunListItemSimulationsItem::class])]
    public array $simulations;

    /**
     * @var SimulationRunListItemTarget $target Target to test against
     */
    #[JsonProperty('target')]
    public SimulationRunListItemTarget $target;
    ...
    /**
     * @var SimulationRunListSummary $summary
     */
    #[JsonProperty('summary')]
    public SimulationRunListSummary $summary;

    /**
     * @param array{
     *   id: string,
     *   orgId: string,
     *   status: value-of<SimulationRunListItemStatus>,
     *   queuedAt: DateTime,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   simulations: array<SimulationRunListItemSimulationsItem>,
