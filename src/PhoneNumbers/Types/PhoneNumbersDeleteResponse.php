...
class PhoneNumbersDeleteResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumbersDeleteResponse
    {
        return new PhoneNumbersDeleteResponse([
     ...
     * @return PhoneNumbersDeleteResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumbersDeleteResponse
    {
        return new PhoneNumbersDeleteResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersDeleteResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumbersDeleteResponse
    {
        return new PhoneNumbersDeleteResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersDeleteResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumbersDeleteResponse
    {
        return new PhoneNumbersDeleteResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersDeleteResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumbersDeleteResponse
    {
        return new PhoneNumbersDeleteResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
