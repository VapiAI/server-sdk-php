 ...
 */
class ServerMessageAssistantSpeechPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageAssistantSpeechPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageAssistantSpeechPhoneNumber
    {
        return new ServerMessageAssistantSpeechPhoneNumber([
     ...
     * @return ServerMessageAssistantSpeechPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageAssistantSpeechPhoneNumber
    {
        return new ServerMessageAssistantSpeechPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageAssistantSpeechPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageAssistantSpeechPhoneNumber
    {
        return new ServerMessageAssistantSpeechPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageAssistantSpeechPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageAssistantSpeechPhoneNumber
    {
        return new ServerMessageAssistantSpeechPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageAssistantSpeechPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageAssistantSpeechPhoneNumber
    {
        return new ServerMessageAssistantSpeechPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
