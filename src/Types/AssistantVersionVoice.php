 ...
 */
class AssistantVersionVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return AssistantVersionVoice
     */
    public static function azure(AzureVoice $azure): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return AssistantVersionVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return AssistantVersionVoice
     */
    public static function customVoice(CustomVoice $customVoice): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
     ...
     * @return AssistantVersionVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return AssistantVersionVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return AssistantVersionVoice
     */
    public static function hume(HumeVoice $hume): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return AssistantVersionVoice
     */
    public static function lmnt(LmntVoice $lmnt): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return AssistantVersionVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return AssistantVersionVoice
     */
    public static function openai(OpenAiVoice $openai): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantVersionVoice
     */
    public static function playht(PlayHtVoice $playht): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return AssistantVersionVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return AssistantVersionVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return AssistantVersionVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
     ...
     * @return AssistantVersionVoice
     */
    public static function tavus(TavusVoice $tavus): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return AssistantVersionVoice
     */
    public static function vapi(VapiVoice $vapi): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return AssistantVersionVoice
     */
    public static function sesame(SesameVoice $sesame): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return AssistantVersionVoice
     */
    public static function inworld(InworldVoice $inworld): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return AssistantVersionVoice
     */
    public static function minimax(MinimaxVoice $minimax): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return AssistantVersionVoice
     */
    public static function xai(XaiVoice $xai): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return AssistantVersionVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): AssistantVersionVoice
    {
        return new AssistantVersionVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
