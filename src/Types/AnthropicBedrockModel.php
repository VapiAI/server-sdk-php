...
class AnthropicBedrockModel extends JsonSerializableType
{
     ...
     *
     * @var ?array<AnthropicBedrockModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([AnthropicBedrockModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<AnthropicBedrockModelModel> $model The specific Anthropic/Claude model that will be used via Bedrock.
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<AnthropicBedrockModelModel>,
