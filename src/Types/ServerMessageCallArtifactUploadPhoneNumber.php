 ...
 */
class ServerMessageCallArtifactUploadPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageCallArtifactUploadPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageCallArtifactUploadPhoneNumber
    {
        return new ServerMessageCallArtifactUploadPhoneNumber([
     ...
     * @return ServerMessageCallArtifactUploadPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageCallArtifactUploadPhoneNumber
    {
        return new ServerMessageCallArtifactUploadPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageCallArtifactUploadPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageCallArtifactUploadPhoneNumber
    {
        return new ServerMessageCallArtifactUploadPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageCallArtifactUploadPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageCallArtifactUploadPhoneNumber
    {
        return new ServerMessageCallArtifactUploadPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageCallArtifactUploadPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageCallArtifactUploadPhoneNumber
    {
        return new ServerMessageCallArtifactUploadPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
