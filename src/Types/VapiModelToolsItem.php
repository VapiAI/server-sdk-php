...
class VapiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return VapiModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return VapiModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return VapiModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
