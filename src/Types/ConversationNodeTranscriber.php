 ...
 */
class ConversationNodeTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return ConversationNodeTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function xai(XaiTranscriber $xai): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
