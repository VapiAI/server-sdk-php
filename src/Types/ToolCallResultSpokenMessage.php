 ...
 */
class ToolCallResultSpokenMessage extends JsonSerializableType
{
    /**
     * @var (
     *    'request-complete'
     ...
     * @return ToolCallResultSpokenMessage
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ToolCallResultSpokenMessage
    {
        return new ToolCallResultSpokenMessage([
     ...
     * @return ToolCallResultSpokenMessage
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ToolCallResultSpokenMessage
    {
        return new ToolCallResultSpokenMessage([
            'type' => 'request-failed',
            'value' => $requestFailed,
