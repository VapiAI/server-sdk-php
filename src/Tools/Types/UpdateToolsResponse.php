...
class UpdateToolsResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return UpdateToolsResponse
     */
    public static function code(CodeTool $code): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'code',
            'value' => $code,
     ...
     * @return UpdateToolsResponse
     */
    public static function dtmf(DtmfTool $dtmf): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return UpdateToolsResponse
     */
    public static function endCall(EndCallTool $endCall): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return UpdateToolsResponse
     */
    public static function function(FunctionTool $function): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return UpdateToolsResponse
     */
    public static function knowledgeBase(KnowledgeBaseTool $knowledgeBase): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'knowledgeBase',
            'value' => $knowledgeBase,
     ...
     * @return UpdateToolsResponse
     */
    public static function transferCall(TransferCallTool $transferCall): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return UpdateToolsResponse
     */
    public static function handoff(HandoffTool $handoff): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return UpdateToolsResponse
     */
    public static function bash(BashTool $bash): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return UpdateToolsResponse
     */
    public static function computer(ComputerTool $computer): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return UpdateToolsResponse
     */
    public static function textEditor(TextEditorTool $textEditor): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return UpdateToolsResponse
     */
    public static function query(QueryTool $query): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return UpdateToolsResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function sms(SmsTool $sms): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return UpdateToolsResponse
     */
    public static function mcp(McpTool $mcp): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return UpdateToolsResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
     ...
     * @return UpdateToolsResponse
     */
    public static function sipRequest(SipRequestTool $sipRequest): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return UpdateToolsResponse
     */
    public static function voicemail(VoicemailTool $voicemail): UpdateToolsResponse
    {
        return new UpdateToolsResponse([
            'type' => 'voicemail',
            'value' => $voicemail,
