...
class UpdateAssistantDraftDto extends JsonSerializableType
{
    /**
     * @var ?UpdateAssistantDraftDtoTranscriber $transcriber These are the options for the assistant's transcriber.
     */
    #[JsonProperty('transcriber')]
    public ?UpdateAssistantDraftDtoTranscriber $transcriber;

    /**
     * @var ?UpdateAssistantDraftDtoModel $model These are the options for the assistant's LLM.
     */
    #[JsonProperty('model')]
    public ?UpdateAssistantDraftDtoModel $model;

    /**
     * @var ?UpdateAssistantDraftDtoVoice $voice These are the options for the assistant's voice.
     */
    #[JsonProperty('voice')]
    public ?UpdateAssistantDraftDtoVoice $voice;
     ...
     *
     * @var ?value-of<UpdateAssistantDraftDtoFirstMessageMode> $firstMessageMode
     */
     ...
     *
     * @var (
     *    value-of<UpdateAssistantDraftDtoVoicemailDetectionZero>
    ...
    /**
     * @var ?array<value-of<UpdateAssistantDraftDtoClientMessagesItem>> $clientMessages These are the messages that will be sent to your Client SDKs. Default is conversation-update,function-call,hang,model-output,speech-update,status-update,transfer-update,transcript,tool-calls,user-interrupted,voice-input,workflow.node.started,assistant.started. You can check the shape of the messages in ClientMessage schema.
     */
    #[JsonProperty('clientMessages'), ArrayType(['string'])]
    public ?array $clientMessages;

    /**
     * @var ?array<value-of<UpdateAssistantDraftDtoServerMessagesItem>> $serverMessages These are the messages that will be sent to your Server URL. Default is conversation-update,end-of-call-report,function-call,hang,speech-update,status-update,tool-calls,transfer-destination-request,handoff-destination-request,user-interrupted,assistant.started. You can check the shape of the messages in ServerMessage schema.
     */
     ...
     *
     * @var (
     *    value-of<UpdateAssistantDraftDtoBackgroundSoundZero>
     *   |string
    ...
    /**
     * @var ?array<UpdateAssistantDraftDtoCredentialsItem> $credentials These are dynamic credentials that will be used for the assistant calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
     */
    #[JsonProperty('credentials'), ArrayType([UpdateAssistantDraftDtoCredentialsItem::class])]
     ...
     *   model?: ?UpdateAssistantDraftDtoModel,
     *   voice?: ?UpdateAssistantDraftDtoVoice,
     *   firstMessage?: ?string,
     *   firstMessageInterruptionsEnabled?: ?bool,
     *   firstMessageMode?: ?value-of<UpdateAssistantDraftDtoFirstMessageMode>,
     *   voicemailDetection?: (
     *    value-of<UpdateAssistantDraftDtoVoicemailDetectionZero>
     *   |GoogleVoicemailDetectionPlan
     *   |OpenAiVoicemailDetectionPlan
     ...
     *   |VapiVoicemailDetectionPlan
     * )|null,
     *   clientMessages?: ?array<value-of<UpdateAssistantDraftDtoClientMessagesItem>>,
     *   serverMessages?: ?array<value-of<UpdateAssistantDraftDtoServerMessagesItem>>,
     ...
     *   credentials?: ?array<UpdateAssistantDraftDtoCredentialsItem>,
     *   hooks?: ?array<(
     *    CallHookCallEnding
     *   |CallHookAssistantSpeechInterrupted
     *   |CallHookCustomerSpeechInterrupted
