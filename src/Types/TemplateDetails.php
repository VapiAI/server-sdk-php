...
class TemplateDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return TemplateDetails
     */
    public static function code(CreateCodeToolDto $code): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'code',
            'value' => $code,
     ...
     * @return TemplateDetails
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return TemplateDetails
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'voicemail',
            'value' => $voicemail,
