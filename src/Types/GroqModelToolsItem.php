...
class GroqModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return GroqModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return GroqModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return GroqModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
