 ...
 */
class CreateWorkflowDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function xai(XaiTranscriber $xai): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
