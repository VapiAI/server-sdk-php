 ...
 */
class ServerMessageEndOfCallReportDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ServerMessageEndOfCallReportDestination
     */
    public static function number(TransferDestinationNumber $number): ServerMessageEndOfCallReportDestination
    {
        return new ServerMessageEndOfCallReportDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ServerMessageEndOfCallReportDestination
     */
    public static function sip(TransferDestinationSip $sip): ServerMessageEndOfCallReportDestination
    {
        return new ServerMessageEndOfCallReportDestination([
            'type' => 'sip',
            'value' => $sip,
