...
class SimulationRunListItemSimulationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'simulation'
     ...
     * @return SimulationRunListItemSimulationsItem
     */
    public static function simulation(SimulationRunSimulationEntry $simulation): SimulationRunListItemSimulationsItem
    {
        return new SimulationRunListItemSimulationsItem([
            'type' => 'simulation',
            'value' => $simulation,
        ]);
    }
     ...
     * @return SimulationRunListItemSimulationsItem
     */
    public static function simulationSuite(SimulationRunSuiteEntry $simulationSuite): SimulationRunListItemSimulationsItem
    {
        return new SimulationRunListItemSimulationsItem([
