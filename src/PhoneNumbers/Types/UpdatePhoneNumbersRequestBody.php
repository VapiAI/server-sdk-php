...
class UpdatePhoneNumbersRequestBody extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return UpdatePhoneNumbersRequestBody
     */
    public static function byoPhoneNumber(UpdateByoPhoneNumberDto $byoPhoneNumber): UpdatePhoneNumbersRequestBody
    {
        return new UpdatePhoneNumbersRequestBody([
     ...
     * @return UpdatePhoneNumbersRequestBody
     */
    public static function twilio(UpdateTwilioPhoneNumberDto $twilio): UpdatePhoneNumbersRequestBody
    {
        return new UpdatePhoneNumbersRequestBody([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return UpdatePhoneNumbersRequestBody
     */
    public static function vonage(UpdateVonagePhoneNumberDto $vonage): UpdatePhoneNumbersRequestBody
    {
        return new UpdatePhoneNumbersRequestBody([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return UpdatePhoneNumbersRequestBody
     */
    public static function vapi(UpdateVapiPhoneNumberDto $vapi): UpdatePhoneNumbersRequestBody
    {
        return new UpdatePhoneNumbersRequestBody([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return UpdatePhoneNumbersRequestBody
     */
    public static function telnyx(UpdateTelnyxPhoneNumberDto $telnyx): UpdatePhoneNumbersRequestBody
    {
        return new UpdatePhoneNumbersRequestBody([
            'provider' => 'telnyx',
            'value' => $telnyx,
