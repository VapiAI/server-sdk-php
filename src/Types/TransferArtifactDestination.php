 ...
 */
class TransferArtifactDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return TransferArtifactDestination
     */
    public static function number(TransferDestinationNumber $number): TransferArtifactDestination
    {
        return new TransferArtifactDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return TransferArtifactDestination
     */
    public static function sip(TransferDestinationSip $sip): TransferArtifactDestination
    {
        return new TransferArtifactDestination([
            'type' => 'sip',
            'value' => $sip,
