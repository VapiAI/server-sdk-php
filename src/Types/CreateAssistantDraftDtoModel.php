 ...
 */
class CreateAssistantDraftDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function anthropic(AnthropicModel $anthropic): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
        ]);
    }
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function anthropicBedrock(AnthropicBedrockModel $anthropicBedrock): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function anyscale(AnyscaleModel $anyscale): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function cerebras(CerebrasModel $cerebras): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function deepSeek(DeepSeekModel $deepSeek): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function google(GoogleModel $google): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function groq(GroqModel $groq): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function inflectionAi(InflectionAiModel $inflectionAi): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function minimax(MinimaxLlmModel $minimax): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'minimax',
            'value' => $minimax,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function openai(OpenAiModel $openai): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function openrouter(OpenRouterModel $openrouter): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function perplexityAi(PerplexityAiModel $perplexityAi): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
     ...
     * @return CreateAssistantDraftDtoModel
     */
    public static function xai(XaiModel $xai): CreateAssistantDraftDtoModel
    {
        return new CreateAssistantDraftDtoModel([
            'provider' => 'xai',
            'value' => $xai,
