 ...
 */
class ServerMessageCampaignPredialPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageCampaignPredialPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageCampaignPredialPhoneNumber
    {
     ...
     * @return ServerMessageCampaignPredialPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageCampaignPredialPhoneNumber
    {
        return new ServerMessageCampaignPredialPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageCampaignPredialPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageCampaignPredialPhoneNumber
    {
        return new ServerMessageCampaignPredialPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageCampaignPredialPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageCampaignPredialPhoneNumber
    {
        return new ServerMessageCampaignPredialPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageCampaignPredialPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageCampaignPredialPhoneNumber
    {
        return new ServerMessageCampaignPredialPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
