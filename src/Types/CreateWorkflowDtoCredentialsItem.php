...
class CreateWorkflowDtoCredentialsItem extends JsonSerializableType
{
    /**
     * @var (
     *    '11labs'
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function anthropicBedrock(CreateAnthropicBedrockCredentialDto $anthropicBedrock): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function s3Compatible(CreateS3CompatibleCredentialDto $s3Compatible): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function microsoft(CreateMicrosoftCredentialDto $microsoft): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
            'provider' => 'microsoft',
            'value' => $microsoft,
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function soniox(CreateSonioxCredentialDto $soniox): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function wellsaid(CreateWellSaidCredentialDto $wellsaid): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function email(CreateEmailCredentialDto $email): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
            'provider' => 'email',
            'value' => $email,
     ...
     * @return CreateWorkflowDtoCredentialsItem
     */
    public static function slackWebhook(CreateSlackWebhookCredentialDto $slackWebhook): CreateWorkflowDtoCredentialsItem
    {
        return new CreateWorkflowDtoCredentialsItem([
