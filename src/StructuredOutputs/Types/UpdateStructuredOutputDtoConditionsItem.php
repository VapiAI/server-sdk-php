...
use Vapi\Types\MinMessagesCondition;
use Vapi\Types\MinCallDurationCondition;
use Vapi\Types\EndedReasonCondition;
use Exception;
use Vapi\Core\Json\JsonDecoder;

class UpdateStructuredOutputDtoConditionsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'minMessages'
