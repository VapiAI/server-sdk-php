...
class CreateSimulationRunResponseSimulationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'simulation'
     ...
     * @return CreateSimulationRunResponseSimulationsItem
     */
    public static function simulation(SimulationRunSimulationEntry $simulation): CreateSimulationRunResponseSimulationsItem
    {
        return new CreateSimulationRunResponseSimulationsItem([
            'type' => 'simulation',
            'value' => $simulation,
        ]);
    }
     ...
     * @return CreateSimulationRunResponseSimulationsItem
     */
    public static function simulationSuite(SimulationRunSuiteEntry $simulationSuite): CreateSimulationRunResponseSimulationsItem
    {
        return new CreateSimulationRunResponseSimulationsItem([
