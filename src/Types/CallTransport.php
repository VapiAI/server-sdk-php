 ...
 */
class CallTransport extends JsonSerializableType
{
    /**
     * @var (
     *    'vapi.websocket'
     ...
     */
    public static function vapiWebsocket(VapiWebsocketTransport $vapiWebsocket): CallTransport
    {
     ...
     * @return CallTransport
     */
    public static function vonage(VonageTransport $vonage): CallTransport
    {
        return new CallTransport([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return CallTransport
     */
    public static function twilio(TwilioTransport $twilio): CallTransport
    {
        return new CallTransport([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return CallTransport
     */
    public static function vapiSip(VapiSipTransport $vapiSip): CallTransport
    {
        return new CallTransport([
            'provider' => 'vapi.sip',
            'value' => $vapiSip,
     ...
     * @return CallTransport
     */
    public static function telnyx(TelnyxTransport $telnyx): CallTransport
    {
        return new CallTransport([
            'provider' => 'telnyx',
            'value' => $telnyx,
     ...
     * @return CallTransport
     */
    public static function daily(VapiWebCallTransport $daily): CallTransport
    {
        return new CallTransport([
            'provider' => 'daily',
            'value' => $daily,
