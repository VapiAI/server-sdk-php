...
class TogetherAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function code(CreateCodeToolDto $code): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'code',
            'value' => $code,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function sipRequest(CreateSipRequestToolDto $sipRequest): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function voicemail(CreateVoicemailToolDto $voicemail): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'voicemail',
            'value' => $voicemail,
