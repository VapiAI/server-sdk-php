...
class KnowledgeBaseToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return KnowledgeBaseToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): KnowledgeBaseToolMessagesItem
    {
        return new KnowledgeBaseToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return KnowledgeBaseToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): KnowledgeBaseToolMessagesItem
    {
        return new KnowledgeBaseToolMessagesItem([
     ...
     * @return KnowledgeBaseToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): KnowledgeBaseToolMessagesItem
    {
        return new KnowledgeBaseToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return KnowledgeBaseToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): KnowledgeBaseToolMessagesItem
    {
        return new KnowledgeBaseToolMessagesItem([
