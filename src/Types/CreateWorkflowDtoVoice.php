 ...
 */
class CreateWorkflowDtoVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function xai(XaiVoice $xai): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
