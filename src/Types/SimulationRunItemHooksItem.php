...
class SimulationRunItemHooksItem extends JsonSerializableType
{
    /**
     * @var (
     ...
     * @return SimulationRunItemHooksItem
     */
    public static function simulationRunStarted(SimulationHookCallStarted $simulationRunStarted): SimulationRunItemHooksItem
    {
        return new SimulationRunItemHooksItem([
     ...
     * @return SimulationRunItemHooksItem
     */
    public static function simulationRunEnded(SimulationHookCallEnded $simulationRunEnded): SimulationRunItemHooksItem
    {
        return new SimulationRunItemHooksItem([
