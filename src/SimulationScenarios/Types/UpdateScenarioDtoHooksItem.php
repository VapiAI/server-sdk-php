...
use Vapi\Types\SimulationHookCallStarted;
use Vapi\Types\SimulationHookCallEnded;
use Exception;
use Vapi\Core\Json\JsonDecoder;

class UpdateScenarioDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     ...
     * @return UpdateScenarioDtoHooksItem
     */
    public static function simulationRunStarted(SimulationHookCallStarted $simulationRunStarted): UpdateScenarioDtoHooksItem
    {
        return new UpdateScenarioDtoHooksItem([
     ...
     * @return UpdateScenarioDtoHooksItem
     */
    public static function simulationRunEnded(SimulationHookCallEnded $simulationRunEnded): UpdateScenarioDtoHooksItem
    {
        return new UpdateScenarioDtoHooksItem([
