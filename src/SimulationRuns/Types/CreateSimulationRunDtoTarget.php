...
use Vapi\Types\SimulationRunTargetAssistant;
use Vapi\Types\SimulationRunTargetSquad;
use Exception;
 ...
 */
class CreateSimulationRunDtoTarget extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return CreateSimulationRunDtoTarget
     */
    public static function assistant(SimulationRunTargetAssistant $assistant): CreateSimulationRunDtoTarget
    {
        return new CreateSimulationRunDtoTarget([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return CreateSimulationRunDtoTarget
     */
    public static function squad(SimulationRunTargetSquad $squad): CreateSimulationRunDtoTarget
    {
        return new CreateSimulationRunDtoTarget([
            'type' => 'squad',
            'value' => $squad,
