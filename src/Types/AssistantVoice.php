 ...
 */
class AssistantVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return AssistantVoice
     */
    public static function xai(XaiVoice $xai): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return AssistantVoice
     */
    public static function microsoft(MicrosoftVoice $microsoft): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'microsoft',
            'value' => $microsoft,
