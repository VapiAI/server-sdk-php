...
class UpdateSipRequestToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateSipRequestToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateSipRequestToolDtoMessagesItem
    {
        return new UpdateSipRequestToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateSipRequestToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateSipRequestToolDtoMessagesItem
    {
        return new UpdateSipRequestToolDtoMessagesItem([
     ...
     * @return UpdateSipRequestToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateSipRequestToolDtoMessagesItem
    {
        return new UpdateSipRequestToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateSipRequestToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateSipRequestToolDtoMessagesItem
    {
        return new UpdateSipRequestToolDtoMessagesItem([
