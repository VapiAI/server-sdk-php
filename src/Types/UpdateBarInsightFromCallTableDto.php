...
class UpdateBarInsightFromCallTableDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?value-of<UpdateBarInsightFromCallTableDtoGroupBy> $groupBy
     */
     ...
     *   groupBy?: ?value-of<UpdateBarInsightFromCallTableDtoGroupBy>,
     *   queries?: ?array<(
     *    JsonQueryOnCallTableWithStringTypeColumn
     *   |JsonQueryOnCallTableWithNumberTypeColumn
     *   |JsonQueryOnCallTableWithStructuredOutputColumn
