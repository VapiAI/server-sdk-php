...
class WorkflowUserEditableCredentialsItem extends JsonSerializableType
{
     ...
     * @return WorkflowUserEditableCredentialsItem
     */
    public static function s3Compatible(CreateS3CompatibleCredentialDto $s3Compatible): WorkflowUserEditableCredentialsItem
    {
        return new WorkflowUserEditableCredentialsItem([
     ...
     * @return WorkflowUserEditableCredentialsItem
     */
    public static function microsoft(CreateMicrosoftCredentialDto $microsoft): WorkflowUserEditableCredentialsItem
    {
        return new WorkflowUserEditableCredentialsItem([
            'provider' => 'microsoft',
            'value' => $microsoft,
