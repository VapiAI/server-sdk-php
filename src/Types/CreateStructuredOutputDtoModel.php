 ...
 */
class CreateStructuredOutputDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return CreateStructuredOutputDtoModel
     */
    public static function anthropicBedrock(WorkflowAnthropicBedrockModel $anthropicBedrock): CreateStructuredOutputDtoModel
    {
        return new CreateStructuredOutputDtoModel([
