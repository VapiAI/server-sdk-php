...
use Vapi\Types\VapiWebsocketTransport;
use Vapi\Types\VonageTransport;
use Vapi\Types\TwilioTransport;
use Vapi\Types\VapiSipTransport;
use Vapi\Types\TelnyxTransport;
use Vapi\Types\VapiWebCallTransport;
use Exception;
 ...
 */
class CreateCallDtoTransport extends JsonSerializableType
{
    /**
     * @var (
     *    'vapi.websocket'
