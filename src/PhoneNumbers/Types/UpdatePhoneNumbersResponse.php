...
class UpdatePhoneNumbersResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): UpdatePhoneNumbersResponse
    {
        return new UpdatePhoneNumbersResponse([
     ...
     * @return UpdatePhoneNumbersResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): UpdatePhoneNumbersResponse
    {
        return new UpdatePhoneNumbersResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return UpdatePhoneNumbersResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): UpdatePhoneNumbersResponse
    {
        return new UpdatePhoneNumbersResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return UpdatePhoneNumbersResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): UpdatePhoneNumbersResponse
    {
        return new UpdatePhoneNumbersResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return UpdatePhoneNumbersResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): UpdatePhoneNumbersResponse
    {
        return new UpdatePhoneNumbersResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
