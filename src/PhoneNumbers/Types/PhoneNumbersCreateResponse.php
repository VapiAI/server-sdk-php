...
class PhoneNumbersCreateResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumbersCreateResponse
    {
        return new PhoneNumbersCreateResponse([
     ...
     * @return PhoneNumbersCreateResponse
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumbersCreateResponse
    {
        return new PhoneNumbersCreateResponse([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersCreateResponse
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumbersCreateResponse
    {
        return new PhoneNumbersCreateResponse([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersCreateResponse
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumbersCreateResponse
    {
        return new PhoneNumbersCreateResponse([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersCreateResponse
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumbersCreateResponse
    {
        return new PhoneNumbersCreateResponse([
            'provider' => 'telnyx',
            'value' => $telnyx,
