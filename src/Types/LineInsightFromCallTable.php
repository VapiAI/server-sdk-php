...
class LineInsightFromCallTable extends JsonSerializableType
{
    /**
     ...
     *
     * @var value-of<LineInsightFromCallTableType> $type
     */
    #[JsonProperty('type')]
    public string $type;
     ...
     *
     * @var ?value-of<LineInsightFromCallTableGroupBy> $groupBy
     */
    ...
    /**
     * @param array{
     *   type: value-of<LineInsightFromCallTableType>,
     *   queries: array<(
     *    JsonQueryOnCallTableWithStringTypeColumn
     *   |JsonQueryOnCallTableWithNumberTypeColumn
     *   |JsonQueryOnCallTableWithStructuredOutputColumn
     ...
     *   groupBy?: ?value-of<LineInsightFromCallTableGroupBy>,
     * } $values
     */
