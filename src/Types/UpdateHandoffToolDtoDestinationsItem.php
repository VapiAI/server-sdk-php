...
class UpdateHandoffToolDtoDestinationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return UpdateHandoffToolDtoDestinationsItem
     */
    public static function squad(HandoffDestinationSquad $squad): UpdateHandoffToolDtoDestinationsItem
    {
        return new UpdateHandoffToolDtoDestinationsItem([
            'type' => 'squad',
            'value' => $squad,
