...
class UpdateToolDraftDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateToolDraftDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateToolDraftDtoMessagesItem
    {
        return new UpdateToolDraftDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateToolDraftDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateToolDraftDtoMessagesItem
    {
        return new UpdateToolDraftDtoMessagesItem([
     ...
     * @return UpdateToolDraftDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateToolDraftDtoMessagesItem
    {
        return new UpdateToolDraftDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateToolDraftDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateToolDraftDtoMessagesItem
    {
        return new UpdateToolDraftDtoMessagesItem([
