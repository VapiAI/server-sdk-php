 ...
 */
class UpdateWorkflowDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function soniox(SonioxTranscriber $soniox): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function xai(XaiTranscriber $xai): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function vapi(VapiTranscriber $vapi): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'vapi',
            'value' => $vapi,
