...
class BashTool extends JsonSerializableType
{
    ...
    /**
     * @var value-of<BashToolSubType> $subType The sub type of tool.
     */
    ...
    /**
     * @var value-of<BashToolName> $name The name of the tool, fixed to 'bash'
     */
    #[JsonProperty('name')]
    public string $name;
    ...
    /**
     * @param array{
     *   subType: value-of<BashToolSubType>,
     *   id: string,
     *   orgId: string,
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
