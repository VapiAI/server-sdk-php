...
use Vapi\Types\SimulationRunSimulationEntry;
use Vapi\Types\SimulationRunSuiteEntry;
use Exception;
use Vapi\Core\Json\JsonDecoder;

class CreateSimulationRunDtoSimulationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'simulation'
     ...
     * @return CreateSimulationRunDtoSimulationsItem
     */
    public static function simulation(SimulationRunSimulationEntry $simulation): CreateSimulationRunDtoSimulationsItem
    {
        return new CreateSimulationRunDtoSimulationsItem([
            'type' => 'simulation',
            'value' => $simulation,
        ]);
    }
     ...
     * @return CreateSimulationRunDtoSimulationsItem
     */
    public static function simulationSuite(SimulationRunSuiteEntry $simulationSuite): CreateSimulationRunDtoSimulationsItem
    {
        return new CreateSimulationRunDtoSimulationsItem([
