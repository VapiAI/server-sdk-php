...
class GetToolsResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return GetToolsResponse
     */
    public static function code(CodeTool $code): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'code',
            'value' => $code,
     ...
     * @return GetToolsResponse
     */
    public static function dtmf(DtmfTool $dtmf): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return GetToolsResponse
     */
    public static function endCall(EndCallTool $endCall): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return GetToolsResponse
     */
    public static function function(FunctionTool $function): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return GetToolsResponse
     */
    public static function knowledgeBase(KnowledgeBaseTool $knowledgeBase): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'knowledgeBase',
            'value' => $knowledgeBase,
     ...
     * @return GetToolsResponse
     */
    public static function transferCall(TransferCallTool $transferCall): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return GetToolsResponse
     */
    public static function handoff(HandoffTool $handoff): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return GetToolsResponse
     */
    public static function bash(BashTool $bash): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return GetToolsResponse
     */
    public static function computer(ComputerTool $computer): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return GetToolsResponse
     */
    public static function textEditor(TextEditorTool $textEditor): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return GetToolsResponse
     */
    public static function query(QueryTool $query): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return GetToolsResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function sms(SmsTool $sms): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return GetToolsResponse
     */
    public static function mcp(McpTool $mcp): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return GetToolsResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): GetToolsResponse
    {
        return new GetToolsResponse([
     ...
     * @return GetToolsResponse
     */
    public static function sipRequest(SipRequestTool $sipRequest): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'sipRequest',
            'value' => $sipRequest,
     ...
     * @return GetToolsResponse
     */
    public static function voicemail(VoicemailTool $voicemail): GetToolsResponse
    {
        return new GetToolsResponse([
            'type' => 'voicemail',
            'value' => $voicemail,
