 ...
 */
class CreateWorkflowDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return CreateWorkflowDtoModel
     */
    public static function anthropicBedrock(WorkflowAnthropicBedrockModel $anthropicBedrock): CreateWorkflowDtoModel
    {
        return new CreateWorkflowDtoModel([
