 ...
 */
class CreateAnthropicBedrockCredentialDtoAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'aws-iam'
     ...
     * @return CreateAnthropicBedrockCredentialDtoAuthenticationPlan
     */
    public static function awsIam(AwsiamCredentialsAuthenticationPlan $awsIam): CreateAnthropicBedrockCredentialDtoAuthenticationPlan
    {
        return new CreateAnthropicBedrockCredentialDtoAuthenticationPlan([
            'type' => 'aws-iam',
            'value' => $awsIam,
        ]);
    }
     ...
     * @return CreateAnthropicBedrockCredentialDtoAuthenticationPlan
     */
    public static function awsSts(AwsStsAuthenticationPlan $awsSts): CreateAnthropicBedrockCredentialDtoAuthenticationPlan
    {
        return new CreateAnthropicBedrockCredentialDtoAuthenticationPlan([
            'type' => 'aws-sts',
            'value' => $awsSts,
