...
class ScenarioHooksItem extends JsonSerializableType
{
    /**
     * @var (
     ...
     * @return ScenarioHooksItem
     */
    public static function simulationRunStarted(SimulationHookCallStarted $simulationRunStarted): ScenarioHooksItem
    {
        return new ScenarioHooksItem([
     ...
     * @return ScenarioHooksItem
     */
    public static function simulationRunEnded(SimulationHookCallEnded $simulationRunEnded): ScenarioHooksItem
    {
        return new ScenarioHooksItem([
