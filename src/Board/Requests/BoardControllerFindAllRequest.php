...
use Vapi\Board\Types\BoardControllerFindAllRequestSortOrder;
use Vapi\Board\Types\BoardControllerFindAllRequestSortBy;
use DateTime;

class BoardControllerFindAllRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<BoardControllerFindAllRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
    public ?string $sortOrder;

    /**
     * @var ?value-of<BoardControllerFindAllRequestSortBy> $sortBy This is the column to sort by. Defaults to 'createdAt'.
     */
     ...
     * @param array{
     *   page?: ?float,
     *   sortOrder?: ?value-of<BoardControllerFindAllRequestSortOrder>,
     *   sortBy?: ?value-of<BoardControllerFindAllRequestSortBy>,
     *   limit?: ?float,
