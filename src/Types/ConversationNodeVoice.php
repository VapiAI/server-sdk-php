 ...
 */
class ConversationNodeVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return ConversationNodeVoice
     */
    public static function wellsaid(WellSaidVoice $wellsaid): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return ConversationNodeVoice
     */
    public static function xai(XaiVoice $xai): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'xai',
            'value' => $xai,
