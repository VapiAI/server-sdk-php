...
class WorkflowCredentialsItem extends JsonSerializableType
{
    /**
     * @var (
     *    '11labs'
     ...
     * @return WorkflowCredentialsItem
     */
    public static function anthropicBedrock(CreateAnthropicBedrockCredentialDto $anthropicBedrock): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function s3Compatible(CreateS3CompatibleCredentialDto $s3Compatible): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function microsoft(CreateMicrosoftCredentialDto $microsoft): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'microsoft',
            'value' => $microsoft,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function soniox(CreateSonioxCredentialDto $soniox): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'soniox',
            'value' => $soniox,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function wellsaid(CreateWellSaidCredentialDto $wellsaid): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'wellsaid',
            'value' => $wellsaid,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function email(CreateEmailCredentialDto $email): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'email',
            'value' => $email,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function slackWebhook(CreateSlackWebhookCredentialDto $slackWebhook): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
